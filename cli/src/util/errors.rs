...
// When the provided connection token doesn't match the one used to set up the original Trixty IDE Server
...
// When the Trixty IDE server has an unrecognized extension (rather than zip or gz)
#[derive(Debug)]
...
/// Internal errors in the Trixty IDE CLI.
