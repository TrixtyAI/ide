...
export class ScopeData {
	 ...
	 * * internal Trixty IDE scopes (e.g. `VSCODE_CLIENT_ID:...`)
	...
	/**
	 * The list of scopes to send to the token endpoint. This is the same as `scopes` but without the internal Trixty IDE scopes.
	 */
