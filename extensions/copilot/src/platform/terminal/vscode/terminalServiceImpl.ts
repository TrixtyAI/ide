...
export class TerminalServiceImpl extends Disposable implements ITerminalService {
	...
	// Trixty IDE will apply them in order from its own cache.
	// So when re-loading Trixty IDE vscode first applies it from its cache, then we apply our contributions.
