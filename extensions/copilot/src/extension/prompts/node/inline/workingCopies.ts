 ...
 * This simulates the EOL sequence behavior of Trixty IDE, namely it keeps the EOL sequence
...
export class WorkingCopyOriginalDocument {
	...
	constructor(
		...
		// Trixty IDE doesn't allow mixed EOL sequences, so the presence of one \r\n
