...
/**
 * Copies the ripgrep files from Trixty IDE's installation into a @github/copilot location
 *
 ...
 * @param vscodeAppRoot Trixty IDE's installation path (where ripgrep is located)
 */
