...
/**
 * Copies the node-pty files from Trixty IDE's installation into a @github/copilot location
 *
 ...
 * @param vscodeAppRoot Trixty IDE's installation path (where node-pty is located)
 */
