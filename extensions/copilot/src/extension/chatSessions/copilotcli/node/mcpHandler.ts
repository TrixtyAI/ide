...
/** The user-facing display label of an MCP server (from Trixty IDE settings). */
 ...
 * to Trixty IDE MCP server display labels.
 */
 ...
 * to Trixty IDE MCP server labels.
 *
 ...
 * @param mcpServerMappings Maps friendly server names (from agent files) → Trixty IDE MCP display labels.
