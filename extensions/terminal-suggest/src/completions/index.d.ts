...
declare namespace Fig {
	...
	interface Generator {
		...
		script?:
		| string[]
		| Function<string[], string[] | undefined> // <-- Trixty IDE edit to make results correct
		| ExecuteCommandInput
		 ...
		 *
		 */
		postProcess?: (out: string, tokens: string[]) => (Suggestion | null)[] | undefined; // <-- Trixty IDE edit to make results correct
		/**
		...
		) => Promise<(Suggestion | null)[] | undefined>; // <-- Trixty IDE edit to make results correct
		/**
		 *
