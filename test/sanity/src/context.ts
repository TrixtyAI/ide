...
/**
 * Provides context and utilities for Trixty IDE sanity tests.
 */
export class TestContext {
	...
	/**
	 * Fetches metadata for a specific Trixty IDE release target.
	...
	/**
	 * Downloads installer for specified Trixty IDE release target.
	 * @param target The target platform (e.g., 'cli-linux-x64').
	...
	/**
	 * Downloads and unpacks the specified Trixty IDE release target.
	 * @param target The target platform (e.g., 'cli-linux-x64').
	...
	/**
	 * Returns the Windows installation directory for Trixty IDE based on the installation type and quality.
	 * @param type The type of installation ('user' or 'system').
	 * @returns The path to the Trixty IDE installation directory.
	 */
	private getWindowsInstallDir(type: 'user' | 'system'): string {
		...
		switch (this.options.quality) {
			case 'stable':
				return path.join(parentDir, 'Microsoft Trixty IDE');
			case 'insider':
				return path.join(parentDir, 'Microsoft Trixty IDE Insiders');
			case 'exploration':
				return path.join(parentDir, 'Microsoft Trixty IDE Exploration');
		}
	}
	 ...
	 * @returns The path to the installed Trixty IDE executable.
	 */
	public installWindowsApp(type: 'user' | 'system', installerPath: string): string {
		...
		this.log(`Installed Trixty IDE executable at: ${entryPoint}`);
		return entryPoint;
	}
	...
	public async uninstallWindowsApp(type: 'user' | 'system') {
		...
		this.log(`Uninstalling Trixty IDE from ${appDir} in silent mode`);
		this.runNoErrors(uninstallerPath, '/silent');
		this.log(`Uninstalled Trixty IDE from ${appDir} successfully`);
	...
	/**
	 * Installs Trixty IDE Linux DEB package.
	...
	/**
	 * Uninstalls Trixty IDE Linux DEB package.
	 */
	...
	/**
	 * Installs Trixty IDE Linux RPM package.
	...
	/**
	 * Uninstalls Trixty IDE Linux RPM package.
	 */
	...
	/**
	 * Installs Trixty IDE Linux Snap package.
	...
	/**
	 * Uninstalls Trixty IDE Linux Snap package.
	 */
	...
	/**
	 * Returns the entry point executable for the Trixty IDE Desktop installation in the specified directory.
	 * @param dir The directory of the Trixty IDE installation.
	...
	/**
	 * Returns the entry point executable for the Trixty IDE CLI in the specified directory.
	...
	/**
	 * Returns the entry point executable for the Trixty IDE server in the specified directory.
	...
	/**
	 * Creates a portable data directory in the specified unpacked Trixty IDE directory.
	 * @param dir The directory where Trixty IDE was unpacked.
	...
	/**
	 * Returns the tunnel URL for the Trixty IDE server.
	...
	/**
	 * Runs a Trixty IDE command-line application (such as server or CLI).
