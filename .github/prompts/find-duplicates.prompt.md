...
description: Find duplicates for a Trixty IDE GitHub issue
...
2. Follow those instructions PRECISELY to identify potential duplicate issues for a given issue number in the Trixty IDE repository.
