---
description: Architecture documentation for Trixty IDE interactive window component. Use when working in `src/vs/workbench/contrib/interactive`
---

# Interactive Window

The interactive window component enables extensions to offer REPL like experience to its users. Trixty IDE provides the user interface and extensions provide the execution environment, code completions, execution results rendering and so on.
