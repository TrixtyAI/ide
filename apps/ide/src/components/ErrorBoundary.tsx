...
export class ErrorBoundary extends Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        <div className="flex-1 flex flex-col items-center justify-center p-8 bg-surface-0 border border-red-900/20 m-2 rounded-lg transition-all animate-in fade-in duration-500">
          ...
          <p className="text-[#666] text-caption mb-6 text-center max-w-[240px] leading-relaxed">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 bg-surface-3 hover:bg-[#222] text-[#999] hover:text-white text-caption font-medium rounded border border-[#333] transition-all"
            >
              <RefreshCw size={13} />
              Retry
            </button>
          ...
          {process.env.NODE_ENV !== "production" && (
            <div className="mt-8 p-3 bg-black border border-border-subtle rounded max-w-full overflow-hidden">
