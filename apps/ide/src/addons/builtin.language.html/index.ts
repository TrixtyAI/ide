...
export const activate = (trixty: typeof import("@/api/trixty").trixty) => {
  logger.debug("[builtin.language.html] Activating...");
  ...
  trixty.languages.setMonarchTokens(languageId, {
    defaultToken: '',
    tokenPostfix: '.html',
    ignoreCase: true,
  ...
  trixty.languages.setIndentation(languageId, { tabSize: 2, insertSpaces: true });
};
