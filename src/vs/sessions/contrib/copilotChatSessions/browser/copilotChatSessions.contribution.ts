...
Registry.as<IConfigurationRegistry>(ConfigurationExtensions.Configuration).registerConfiguration({
	...
	properties: {
		[COPILOT_MULTI_CHAT_SETTING]: {
			...
			default: false,
			tags: ['preview'],
			description: localize('sessions.trixty.ai.multiChatSessions', "Whether to enable multiple chats within a single session in the Copilot Chat sessions provider."),
		},
	},
});
