...
export const InAutomationContext = new RawContextKey<boolean>('inAutomation', false, localize('inAutomation', "Whether Trixty IDE is running under automation/smoke test"));
