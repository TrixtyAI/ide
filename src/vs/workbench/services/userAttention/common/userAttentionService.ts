...
/**
 * Service that tracks whether the user is actively paying attention to Trixty IDE.
 *
 * This is determined by:
 * * Trixty IDE window has focus
...
export interface IUserAttentionService {
	 ...
	 * This includes keyboard typing and mouse movements/clicks while Trixty IDE is focused.
	 * The 500ms window prevents event spam from continuous mouse movement.
	 */
	readonly isUserActive: IObservable<boolean>;

	/**
	 * Observable that indicates whether the user is actively paying attention to Trixty IDE.
	 * This is true when:
	 * * Trixty IDE has focus, AND
	 * * There was user activity within the last minute
	 */
	readonly hasUserAttention: IObservable<boolean>;

	/**
	 * The total time in milliseconds that the user has been paying attention to Trixty IDE.
	 */
