...
export class ChatEntitlementService extends Disposable implements IChatEntitlementService {
	...
	get previewFeaturesDisabled(): boolean {
		return this.contextKeyService.getContextKeyValue<boolean>('trixty.ai.previewFeaturesDisabled') === true;
	}

	get clientByokEnabled(): boolean {
		return this.contextKeyService.getContextKeyValue<boolean>('trixty.ai.clientByokEnabled') === true;
	}
