...
export class PromptsService extends Disposable implements IPromptsService {
	 ...
	 * The number in the returned tuple is textModel.getVersionId(), which is an internal Trixty IDE counter that increments every time the text model's content changes.
	 */
