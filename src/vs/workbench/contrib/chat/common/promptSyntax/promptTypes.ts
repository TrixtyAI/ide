 ...
 */
export const AGENT_DEBUG_LOG_ENABLED_SETTING = 'trixty.ai.chat.agentDebugLog.enabled';

/**
 * Configuration key for enabling file logging for the agent debug log.
 */
export const AGENT_DEBUG_LOG_FILE_LOGGING_ENABLED_SETTING = 'trixty.ai.chat.agentDebugLog.fileLogging.enabled';
