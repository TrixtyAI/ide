...
export class ChatSetupContribution extends Disposable implements IWorkbenchContribution {
	...
	private registerActions(context: ChatEntitlementContext, requests: ChatEntitlementRequests, controller: Lazy<ChatSetupController>): void {
		...
		class ChatSetupTriggerAction extends Action2 {
			...
			static CHAT_SETUP_ACTION_LABEL = localize2('triggerChatSetup', "Use AI Features with Trixty AI...");
		...
		class UpgradePlanAction extends Action2 {
			constructor() {
				super({
					...
					title: localize2('managePlan', "Upgrade Trixty AI Plan"),
		...
		class EnableOveragesAction extends Action2 {
			constructor() {
				super({
					...
					title: localize2('manageOverages', "Manage Trixty AI Usage"),
					category: localize2('chat.category', 'Chat'),
					f1: true,
					precondition: ContextKeyExpr.and(
						ChatContextKeys.Setup.hidden.negate(),
		...
		registerGenerateCodeCommand('chat.internal.explain', 'trixty.ai.chat.explain');
		registerGenerateCodeCommand('chat.internal.fix', 'trixty.ai.chat.fix');
		registerGenerateCodeCommand('chat.internal.review', 'trixty.ai.chat.review');
		registerGenerateCodeCommand('chat.internal.codeReview.run', 'trixty.ai.chat.codeReview.run');
