...
/**
 * Allows webviews to monitor when an element in the Trixty IDE editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. Trixty IDE needs to see this
