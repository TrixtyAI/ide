 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in Trixty IDE UI).
 */
 ...
 * to represent terminals that appear in other parts of the Trixty IDE UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their Trixty IDE OSC `SetMarker`
