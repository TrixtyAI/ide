...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Trixty IDE in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Trixty IDE and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
