...
/**
 * The main Trixty IDE application. There will only ever be one instance,
...
export class CodeApplication extends Disposable {
	...
	async startup(): Promise<void> {
		this.logService.debug('Starting Trixty IDE');
		...
		// "com.microsoft.", which breaks native tabs for Trixty IDE when using this
