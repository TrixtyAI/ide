...
export abstract class AbstractExtensionGalleryService implements IExtensionGalleryService {
	...
	constructor(
		...
		let extensionsGallery = productService.extensionsGallery;
		if (this.configurationService.getValue('trixtyIDE.marketplace') === 'vscode') {
			extensionsGallery = {
				serviceUrl: 'https://marketplace.visualstudio.com/_apis/public/gallery',
				itemUrl: 'https://marketplace.visualstudio.com/items',
				publisherUrl: 'https://marketplace.visualstudio.com/publishers',
				resourceUrlTemplate: 'https://{publisher}.vscode-unpkg.net/{publisher}/{name}/{version}/extension/{path}',
				extensionUrlTemplate: 'https://{publisher}.vscode-unpkg.net/{publisher}/{name}/{version}/extension/{path}',
				controlUrl: '',
				nlsBaseUrl: ''
			};
		}
		this.extensionsControlUrl = extensionsGallery?.controlUrl;
		this.unpkgResourceApi = extensionsGallery?.extensionUrlTemplate;
